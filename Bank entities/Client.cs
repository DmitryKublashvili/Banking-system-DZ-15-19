...
{
    abstract class Client : INotifyPropertyChanged, ICloneable
    {
        /// <summary>
        /// Конструктор класса
        /// </summary>
        ...
        public bool IsSelected
        {
            ...
            set
            {
                if (_isSelected != value)
                {
                    ...
                    if (_isSelected)
                    {
                       DataContextForMainWindow.SelectedClient = this;     // привязка выбранного элемента к источнику данных для заполнения списка работников выбранного отдела
                    }
                }
            }
        }
